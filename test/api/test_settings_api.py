...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("SESSION_PRIMARY_SUPERVISOR_EXISTS", 409),
        ("PROJECT_SOURCE_NOT_GIT", 409),
        ("WORK_CONTEXT_REQUEST_CONFLICT", 409),
        ("WORK_CONTEXT_AUTHORITY_CONFLICT", 409),
        ("WORK_CONTEXT_AUTHORITY_CHANGED", 409),
        ("WORK_CONTEXT_PROVIDER_LAUNCH_UNCERTAIN", 409),
