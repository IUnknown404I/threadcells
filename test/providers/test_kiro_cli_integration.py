...
Usage:
    # Headless
    THREADCELLS_RUN_LIVE_PROVIDER_TESTS=1 pytest test/providers/test_kiro_cli_integration.py -v -o "addopts="
...
def kiro_cli_available():
    if os.environ.get("THREADCELLS_RUN_LIVE_PROVIDER_TESTS") != "1":
        pytest.skip("live provider tests require THREADCELLS_RUN_LIVE_PROVIDER_TESTS=1")
