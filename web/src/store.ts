...
interface Store {
  ...
  deleteSession: (name: string, confirmDirtyWorkspace?: boolean, cancelUnresolvedWork?: boolean, cancellationPlanToken?: string | null) => Promise<boolean>
...
export const useStore = create<Store>((set, get) => ({
  ...
  deleteSession: async (name, confirmDirtyWorkspace = false, cancelUnresolvedWork = false, cancellationPlanToken = null) => {
    try {
      await api.deleteSession(name, confirmDirtyWorkspace, cancelUnresolvedWork, cancellationPlanToken)
