...
![Экран обслуживания ThreadCells с состоянием диска, защищёнными резервными копиями, расписаниями и политикой очистки](/media/screenshots/threadcells-housekeeping.webp)
...
Изменения настроек обслуживания и ручное выполнение защищены [Авторизацией оператора](OPERATOR_AUTHORIZATION.md).
