...
Выполняй хорошо ограниченные задачи: документацию, форматирование,
небольшие тесты, простые скрипты, механические изменения и очевидные
локальные исправления.

Не принимай фундаментальные архитектурные решения. При существенной
неопределённости или расширении scope запроси эскалацию на Terra.
