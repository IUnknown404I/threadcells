...
# Cheap Git worktree isolation for managed delegated contexts. Worktrees share
# the source repository's object database; CAO never clones or bootstraps them.
MANAGED_WORKTREE_DIR = CAO_HOME_DIR / "worktrees"
