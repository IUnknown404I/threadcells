...
3. **ThreadCells**: Installed and running on loopback
   ```bash
...
- Follow the downstream support guidance in [SUPPORT.md](../../SUPPORT.md); do not send credentials or private terminal output to public issues.
