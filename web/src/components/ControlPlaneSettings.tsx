...
function HousekeepingSettingsPage() {
  ...
  const reclaimByClass = actionable.reduce((current: Record<string, number>, candidate) => ({ ...current, [candidate.category]: (current[candidate.category] || 0) + Number(candidate.estimated_reclaim_bytes || 0) }), {})
