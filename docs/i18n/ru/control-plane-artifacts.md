...
6. Перед запуском используйте разрешённый предварительный просмотр, а после импорта — экспорт, чтобы подтвердить канонический артефакт с удалёнными чувствительными данными.
