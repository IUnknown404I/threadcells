...
La versión preliminar técnica `0.3.0-alpha.2` admite un único host Ubuntu/Debian Linux, acceso loopback por defecto y una configuración centrada en Codex. Los agentes nativos pueden ejecutar comandos potentes; los worktrees no son un sandbox de seguridad. Consulta las [limitaciones](docs/LIMITATIONS.md) antes de evaluarlo.
