...
| --- | --- |
| ![Развёрнутая живая сессия ThreadCells с работающим агентом и агентом, заменённым при восстановлении](../../launch-media/output/screenshots/threadcells-session-workflow.png) | ![Экран обслуживания ThreadCells с состоянием диска, защищёнными резервными копиями, расписанием и политикой очистки](../../launch-media/output/screenshots/threadcells-housekeeping.png) |
