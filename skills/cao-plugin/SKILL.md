---
name: cao-plugin
description: Create a ThreadCells observer plugin using the compatible cao.plugins entry point. Use this skill for lifecycle or messaging observers, scaffolding, event discovery, and external integrations. Observer plugins are distinct from provider adapters.
---
