...
export const analyticsCopy: Record<Locale, AnalyticsCopy> = {
  en: {
    ...
    allow: 'Allow', decline: 'Decline', details: 'Details', settings: 'Analytics settings', close: 'Close', choice: 'Your analytics choice', privacyKicker: 'Privacy notice',
  ...
  ru: {
    ...
    allow: 'Разрешить', decline: 'Отклонить', details: 'Подробнее', settings: 'Настройки аналитики', close: 'Закрыть', choice: 'Ваш выбор аналитики', privacyKicker: 'Уведомление о конфиденциальности',
  ...
  'zh-CN': {
    ...
    allow: '允许', decline: '拒绝', details: '详情', settings: '分析设置', close: '关闭', choice: '您的分析选择', privacyKicker: '隐私说明',
  ...
  es: {
    ...
    allow: 'Permitir', decline: 'Rechazar', details: 'Detalles', settings: 'Configuración de analítica', close: 'Cerrar', choice: 'Tu elección de analítica', privacyKicker: 'Aviso de privacidad',
  ...
  'pt-BR': {
    ...
    allow: 'Permitir', decline: 'Recusar', details: 'Detalhes', settings: 'Configurações de análises', close: 'Fechar', choice: 'Sua escolha de análises', privacyKicker: 'Aviso de privacidade',
  ...
  de: {
    ...
    allow: 'Erlauben', decline: 'Ablehnen', details: 'Details', settings: 'Analyse-Einstellungen', close: 'Schließen', choice: 'Deine Analysewahl', privacyKicker: 'Datenschutzhinweis',
  ...
  ja: {
    ...
    allow: '許可', decline: '拒否', details: '詳細', settings: '分析設定', close: '閉じる', choice: '分析に関する選択', privacyKicker: 'プライバシーに関するお知らせ',
