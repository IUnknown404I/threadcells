...
- Initialize the privileged Full Cleanup helper with the runtime account's canonical home and a narrowly bounded capability set that permits its required identity transitions before executing an owner-authorized plan.
