...
# 
# Usage:
#   bash <(curl -s https://raw.githubusercontent.com/IUnknown404I/threadcells/main/tmux-install.sh)
#   or
...
# Configuration
readonly TMUX_CONF_URL="https://raw.githubusercontent.com/IUnknown404I/threadcells/main/.tmux.conf"
