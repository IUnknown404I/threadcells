...
- The socket-activated Full Cleanup helper now binds lazy runtime state discovery to the configured runtime account's home before dropping privileges, while preserving the existing operator, plan, idle-fence, and active-release checks.
