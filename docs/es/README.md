[English](../../README.md) · [Русский](../ru/README.md) · [简体中文](../zh-CN/README.md) · **Español** · [Português (Brasil)](../pt-BR/README.md) · [Deutsch](../de/README.md) · [日本語](../ja/README.md)
...
Empieza por [¿Qué es ThreadCells?](../OVERVIEW.md), [Configuración rápida](../../QUICK_SETUP.md) y [Tu primer proyecto y agente](../FIRST_AGENT.md). La guía pública completa abarca [Instalación](../INSTALLATION.md), [Conceptos básicos](../CONCEPTS.md), [Notificaciones de Telegram](../TELEGRAM_NOTIFICATIONS.md), [Acceso remoto](../REMOTE_ACCESS.md), [Seguridad](../../SECURITY.md) y [Operaciones](../OPERATIONS.md). El lector integrado en `/docs` sirve el mismo corpus de documentación empaquetado y seleccionado mediante allowlist.
...
La versión preliminar técnica `0.4.1-alpha` admite un único host Ubuntu/Debian Linux, acceso loopback por defecto y una configuración centrada en Codex. Los agentes nativos pueden ejecutar comandos potentes; los worktrees no son un sandbox de seguridad. Consulta las [limitaciones](../LIMITATIONS.md) antes de evaluarlo.
...
ThreadCells es un proyecto derivado independiente y no oficial de AWS Labs CLI Agent Orchestrator. No está patrocinado ni respaldado por Amazon Web Services. El trabajo original se distribuye bajo Apache License 2.0; consulta [NOTICE](../../NOTICE), la [procedencia](../PROVENANCE.md) y los [cambios respecto al upstream](../CHANGES_FROM_UPSTREAM.md).
