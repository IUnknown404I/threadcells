...
Os locales de lançamento são `en`, `ru`, `zh-CN`, `es`, `pt-BR`, `de` e `ja`. O Markdown canônico permanece na origem nomeada por `docs/DOCS_MANIFEST.json`. Cada documento não inglês fica em `docs/i18n/LOCALE/SLUG.md` e registra:
